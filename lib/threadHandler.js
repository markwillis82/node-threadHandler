...
// set maxTimeout to user defines in milliseconds. after a process has run for the time allowed process will be killed.
var setMaxTimeout = function(total) {
	...
	processKillInterval = setInterval(checkTimeout,200);
};
...
// This function will currently run every 200 milliseconds and will check if a process has been running to a set amount of time. and kill process if necessary 
